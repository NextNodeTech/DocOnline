    ...
    return (
        <>
            ...
            <div style={{ display: "flex" }}>
                    ...
                    <div>
                        ...
                        <Paper>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', marginTop: '5px', paddingBottom: '5px' }} >
                    ...
                    <div >
                        ...
                        <Paper style={{ paddingBottom: '10px' }} >
                            <div style={{ paddingTop: '10px' }} >
                                ...
                                <div style={{ marginTop: '5px', float: "right", paddingBottom: '5px' }}>
                                    <Button variant="contained" color="primary" style={{ marginRight: '10px' }} >
                                        Save
                                    </Button>
                                ...
                                <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                    <Grid item style={{ marginLeft: '10px' }} >
                                        <div>
                                            <Typography variant="body1">Classic Cholera <span style={{ color: 'red' }}>A00.0</span></Typography>
                                            <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                        </div>
                                    </Grid>
                                ...
                                <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                    <Grid item style={{ marginLeft: '10px' }} >
                                        <div>
                                            <Typography variant="body1">infectious &parasitic diseases<span style={{ color: 'red' }}>A00.0</span></Typography>
                                            <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                        </div>
                                    </Grid>
                                    <Grid item style={{ marginRight: '5px' }}>
                        ...
                        <Paper style={{ paddingBottom: '10px' }} >
                            <div style={{ paddingTop: '10px' }} >
                                ...
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <TextField style={{ width: '70px', marginLeft: '10px' }}
                                        label="Now"
                                        id="outlined-size-small"
                                        defaultValue=""
                                        variant="outlined"
                                    ...
                                    <Typography variant="body1" style={{ marginLeft: '10px', fontSize: '12px', marginTop: '8px' }}>For</Typography>

                                    <TextField style={{ width: '100px', marginLeft: '10px' }}
                                        label="Day"
                                        id="outlined-size-small"
                                        defaultValue=""
                                        variant="outlined"
                                ...
                                <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                    <Grid item style={{ marginLeft: '10px' }} >
                                        <div>
                                            <Typography variant="body1">PANADOL <span style={{ color: 'red' }}>GSK</span></Typography>
                                            <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                        </div>
                                    </Grid>
                                    <Grid item style={{ marginRight: '5px' }}>
                                ...
                                <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                    <Grid item style={{ marginLeft: '10px' }} >
                                        <div>
                                            <Typography variant="body1">Co-amoxiclav <span style={{ color: 'red' }}>30 ug</span></Typography>
                                            <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                        </div>
                                    </Grid>
                                    <Grid item style={{ marginRight: '5px' }}>
                ...
                {/* div one end////////// */}
                <div style={{ marginTop: "8px", width: '50%', marginLeft: '5px' }}  >
                    <div >
                        <AppBar position="static" style={{ color: "#FFF" }} >
                            <Toolbar>
                        ...
                        <Paper>
                            <div style={{ paddingTop: '10px', display: 'flex' }} >
                                <Grid container justify={"space-between"} >
                                    ...
                                    <Grid>
                                        <div>
                                            <TextareaAutosize style={{ width: '330px', height: '40px' }}
                                                maxRows={3}
                            ...
                            <div style={{ paddingTop: '10px', display: 'flex' }} >
                                <Grid container justify={"space-between"} >
                                            ...
                                            <div className={classes.Radiobuttons} >
                                                <FormControl component="fieldset">
                                                    ...
                                                    <RadioGroup row aria-label="position" name="position" defaultValue="top">
                                                        ...
                                                        // labelPlacement="bottom"
                                                        />
                                                        <FormControlLabel value="end" control={<Radio color="primary" />} label="Start Now" />
                                                    </RadioGroup>
                                                </FormControl>
                                            </div>
                                            <TextField style={{ width: '500px' }}
                                    ...
                                    <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                        <Grid item style={{ marginLeft: '10px' }} >
                                            <div>
                                                <Typography variant="body1">DOPPLER <span style={{ color: 'red' }}> (CAROTID)</span></Typography>
                                                <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                            </div>
                                        </Grid>
                                        <Grid >
                            ...
                            <div style={{ paddingTop: '10px', display: 'flex' }} >
                                <Grid container justify={"space-between"} >
                                    ...
                                    <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                        <Grid item style={{ marginLeft: '10px' }} >
                                            <div>
                                                <Typography variant="body1">24 Hours Urinary Magnesium <span style={{ color: 'red' }}>34</span></Typography>
                                                <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                            </div>
                                        </Grid>
                                        <Grid >
                                    ...
                                    <Grid container justify={"space-between"} style={{ borderBottom: '1px solid gray', paddingBottom: '1px', marginBottom: '5px' }}>
                                        <Grid item style={{ marginLeft: '10px' }} >
                                            <div>
                                                <Typography variant="body1">24 Hours urinary Cortisol</Typography>
                                                <Typography variant="body2" style={{ color: 'gray' }}>start : 24/07/2019 04:13:12 PM</Typography>
                                            </div>
                                        </Grid>
                                        <Grid >
                        ...
                        <Paper>
                            <div style={{ paddingTop: '10px', display: 'flex' }} >
                                <Grid container justify={"space-between"} >
                                    ...
                                    <Grid item style={{ width: '100%', marginLeft: '10px', borderBottom: '1px solid gray' }} >
                                        <div  >
                                            <Typography>
                                                Select Allergen
                                            </Typography>
